/* Copied exactly from net.minecraft.world.level.levelgen.OTGDensityFunctions except for
...
public final class OTGDensityFunctions {
    ...
    public static final Codec<DensityFunction> DIRECT_CODEC = Codec.either(NOISE_VALUE_CODEC, CODEC)
        .xmap(
            p_224023_ -> p_224023_.map(OTGDensityFunctions::constant, Function.identity()),
            p_224051_ -> p_224051_ instanceof OTGDensityFunctions.Constant densityfunctions$constant
    ...
    public static MapCodec<? extends DensityFunction> bootstrap(Registry<MapCodec<? extends DensityFunction>> p_208343_) {
        register(p_208343_, "blend_alpha", OTGDensityFunctions.BlendAlpha.CODEC);
        register(p_208343_, "blend_offset", OTGDensityFunctions.BlendOffset.CODEC);
        register(p_208343_, "beardifier", OTGDensityFunctions.BeardifierMarker.CODEC);
        register(p_208343_, "old_blended_noise", BlendedNoise.CODEC);

        for (OTGDensityFunctions.Marker.Type densityfunctions$marker$type : OTGDensityFunctions.Marker.Type.values()) {
            register(p_208343_, densityfunctions$marker$type.getSerializedName(), densityfunctions$marker$type.codec);
        }

        register(p_208343_, "noise", OTGDensityFunctions.Noise.CODEC);
        register(p_208343_, "end_islands", OTGDensityFunctions.EndIslandDensityFunction.CODEC);
        register(p_208343_, "weird_scaled_sampler", OTGDensityFunctions.WeirdScaledSampler.CODEC);
        register(p_208343_, "shifted_noise", OTGDensityFunctions.ShiftedNoise.CODEC);
        register(p_208343_, "range_choice", OTGDensityFunctions.RangeChoice.CODEC);
        register(p_208343_, "shift_a", OTGDensityFunctions.ShiftA.CODEC);
        register(p_208343_, "shift_b", OTGDensityFunctions.ShiftB.CODEC);
        register(p_208343_, "shift", OTGDensityFunctions.Shift.CODEC);
        register(p_208343_, "blend_density", OTGDensityFunctions.BlendDensity.CODEC);
        register(p_208343_, "clamp", OTGDensityFunctions.Clamp.CODEC);

        for (OTGDensityFunctions.Mapped.Type densityfunctions$mapped$type : OTGDensityFunctions.Mapped.Type.values()) {
            register(p_208343_, densityfunctions$mapped$type.getSerializedName(), densityfunctions$mapped$type.codec);
        }

        for (OTGDensityFunctions.TwoArgumentSimpleFunction.Type densityfunctions$twoargumentsimplefunction$type : OTGDensityFunctions.TwoArgumentSimpleFunction.Type.values()) {
        ...
        register(p_208343_, "spline", OTGDensityFunctions.Spline.CODEC);
        register(p_208343_, "constant", OTGDensityFunctions.Constant.CODEC);
        return register(p_208343_, "y_clamped_gradient", OTGDensityFunctions.YClampedGradient.CODEC);
    }
    ...
    public static DensityFunction interpolated(DensityFunction p_208282_) {
        return new OTGDensityFunctions.Marker(OTGDensityFunctions.Marker.Type.Interpolated, p_208282_);
    }

    public static DensityFunction flatCache(DensityFunction p_208362_) {
        return new OTGDensityFunctions.Marker(OTGDensityFunctions.Marker.Type.FlatCache, p_208362_);
    }

    public static DensityFunction cache2d(DensityFunction p_208374_) {
        return new OTGDensityFunctions.Marker(OTGDensityFunctions.Marker.Type.Cache2D, p_208374_);
    }

    public static DensityFunction cacheOnce(DensityFunction p_208381_) {
        return new OTGDensityFunctions.Marker(OTGDensityFunctions.Marker.Type.CacheOnce, p_208381_);
    }

    public static DensityFunction cacheAllInCell(DensityFunction p_208388_) {
        return new OTGDensityFunctions.Marker(OTGDensityFunctions.Marker.Type.CacheAllInCell, p_208388_);
    }
    ...
    public static DensityFunction mappedNoise(
        ...
        return mapFromUnitTo(new OTGDensityFunctions.Noise(new DensityFunction.NoiseHolder(p_208337_), p_208338_, p_208339_), p_208340_, p_208341_);
    }
    ...
    public static DensityFunction shiftedNoise2d(
        ...
        return new OTGDensityFunctions.ShiftedNoise(p_208297_, zero(), p_208298_, p_208299_, 0.0, new DensityFunction.NoiseHolder(p_208300_));
    }
    ...
    public static DensityFunction noise(Holder<NormalNoise.NoiseParameters> p_208369_, double p_208370_, double p_208371_) {
        return new OTGDensityFunctions.Noise(new DensityFunction.NoiseHolder(p_208369_), p_208370_, p_208371_);
    }
    ...
    public static DensityFunction rangeChoice(DensityFunction p_208288_, double p_208289_, double p_208290_, DensityFunction p_208291_, DensityFunction p_208292_) {
        return new OTGDensityFunctions.RangeChoice(p_208288_, p_208289_, p_208290_, p_208291_, p_208292_);
    }

    public static DensityFunction shiftA(Holder<NormalNoise.NoiseParameters> p_208367_) {
        return new OTGDensityFunctions.ShiftA(new DensityFunction.NoiseHolder(p_208367_));
    }

    public static DensityFunction shiftB(Holder<NormalNoise.NoiseParameters> p_208379_) {
        return new OTGDensityFunctions.ShiftB(new DensityFunction.NoiseHolder(p_208379_));
    }

    public static DensityFunction shift(Holder<NormalNoise.NoiseParameters> p_208386_) {
        return new OTGDensityFunctions.Shift(new DensityFunction.NoiseHolder(p_208386_));
    }

    public static DensityFunction blendDensity(DensityFunction p_208390_) {
        return new OTGDensityFunctions.BlendDensity(p_208390_);
    }

    public static DensityFunction endIslands(long p_208272_) {
        return new OTGDensityFunctions.EndIslandDensityFunction(p_208272_);
    }

    public static DensityFunction weirdScaledSampler(
        DensityFunction p_208316_, Holder<NormalNoise.NoiseParameters> p_208317_, OTGDensityFunctions.WeirdScaledSampler.RarityValueMapper p_208318_
    ) {
        return new OTGDensityFunctions.WeirdScaledSampler(p_208316_, new DensityFunction.NoiseHolder(p_208317_), p_208318_);
    }

    public static DensityFunction add(DensityFunction p_208294_, DensityFunction p_208295_) {
        return OTGDensityFunctions.TwoArgumentSimpleFunction.create(OTGDensityFunctions.TwoArgumentSimpleFunction.Type.ADD, p_208294_, p_208295_);
    }

    public static DensityFunction mul(DensityFunction p_208364_, DensityFunction p_208365_) {
        return OTGDensityFunctions.TwoArgumentSimpleFunction.create(OTGDensityFunctions.TwoArgumentSimpleFunction.Type.MUL, p_208364_, p_208365_);
    }

    public static DensityFunction min(DensityFunction p_208376_, DensityFunction p_208377_) {
        return OTGDensityFunctions.TwoArgumentSimpleFunction.create(OTGDensityFunctions.TwoArgumentSimpleFunction.Type.MIN, p_208376_, p_208377_);
    }

    public static DensityFunction max(DensityFunction p_208383_, DensityFunction p_208384_) {
        return OTGDensityFunctions.TwoArgumentSimpleFunction.create(OTGDensityFunctions.TwoArgumentSimpleFunction.Type.MAX, p_208383_, p_208384_);
    }

    public static DensityFunction spline(CubicSpline<OTGDensityFunctions.Spline.Point, OTGDensityFunctions.Spline.Coordinate> p_224021_) {
        return new OTGDensityFunctions.Spline(p_224021_);
    }
    ...
    public static DensityFunction constant(double p_208265_) {
        return new OTGDensityFunctions.Constant(p_208265_);
    }

    public static DensityFunction yClampedGradient(int p_208267_, int p_208268_, double p_208269_, double p_208270_) {
        return new OTGDensityFunctions.YClampedGradient(p_208267_, p_208268_, p_208269_, p_208270_);
    }

    public static DensityFunction map(DensityFunction p_208313_, OTGDensityFunctions.Mapped.Type p_208314_) {
        return OTGDensityFunctions.Mapped.create(p_208314_, p_208313_);
    }
    ...
    public static DensityFunction lerp(DensityFunction p_208302_, DensityFunction p_208303_, DensityFunction p_208304_) {
        if (p_208303_ instanceof OTGDensityFunctions.Constant densityfunctions$constant) {
    ...
    static record Ap2(
        OTGDensityFunctions.TwoArgumentSimpleFunction.Type type, DensityFunction argument1, DensityFunction argument2, double minValue, double maxValue
    ) implements OTGDensityFunctions.TwoArgumentSimpleFunction {
        @Override
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_208412_) {
            return p_208412_.apply(
                OTGDensityFunctions.TwoArgumentSimpleFunction.create(this.type, this.argument1.mapAll(p_208412_), this.argument2.mapAll(p_208412_))
            );
        }
    ...
    static record BlendDensity(DensityFunction input) implements OTGDensityFunctions.TransformerWithContext {
        static final KeyDispatchDataCodec<OTGDensityFunctions.BlendDensity> CODEC = OTGDensityFunctions.singleFunctionArgumentCodec(
            OTGDensityFunctions.BlendDensity::new, OTGDensityFunctions.BlendDensity::input
        );
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_208556_) {
            return p_208556_.apply(new OTGDensityFunctions.BlendDensity(this.input.mapAll(p_208556_)));
        }
    ...
    protected static record Clamp(DensityFunction input, double minValue, double maxValue) implements OTGDensityFunctions.PureTransformer {
        private static final MapCodec<OTGDensityFunctions.Clamp> DATA_CODEC = RecordCodecBuilder.mapCodec(
            p_208597_ -> p_208597_.group(
                        DensityFunction.DIRECT_CODEC.fieldOf("input").forGetter(OTGDensityFunctions.Clamp::input),
                        OTGDensityFunctions.NOISE_VALUE_CODEC.fieldOf("min").forGetter(OTGDensityFunctions.Clamp::minValue),
                        OTGDensityFunctions.NOISE_VALUE_CODEC.fieldOf("max").forGetter(OTGDensityFunctions.Clamp::maxValue)
                    )
                    .apply(p_208597_, OTGDensityFunctions.Clamp::new)
        );
        public static final KeyDispatchDataCodec<OTGDensityFunctions.Clamp> CODEC = OTGDensityFunctions.makeCodec(DATA_CODEC);
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_208599_) {
            return new OTGDensityFunctions.Clamp(this.input.mapAll(p_208599_), this.minValue, this.maxValue);
        }
    ...
    static record Constant(double value) implements DensityFunction.SimpleFunction {
        static final KeyDispatchDataCodec<OTGDensityFunctions.Constant> CODEC = OTGDensityFunctions.singleArgumentCodec(
            OTGDensityFunctions.NOISE_VALUE_CODEC, OTGDensityFunctions.Constant::new, OTGDensityFunctions.Constant::value
        );
        static final OTGDensityFunctions.Constant ZERO = new OTGDensityFunctions.Constant(0.0);
    ...
    protected static final class EndIslandDensityFunction implements DensityFunction.SimpleFunction {
        public static final KeyDispatchDataCodec<OTGDensityFunctions.EndIslandDensityFunction> CODEC = KeyDispatchDataCodec.of(
            MapCodec.unit(new OTGDensityFunctions.EndIslandDensityFunction(0L))
        );
    ...
    public static record HolderHolder(Holder<DensityFunction> function) implements DensityFunction {
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_208643_) {
            return p_208643_.apply(new OTGDensityFunctions.HolderHolder(new Holder.Direct<>(this.function.value().mapAll(p_208643_))));
        }
    ...
    protected static record Mapped(OTGDensityFunctions.Mapped.Type type, DensityFunction input, double minValue, double maxValue)
        implements OTGDensityFunctions.PureTransformer {
        public static OTGDensityFunctions.Mapped create(OTGDensityFunctions.Mapped.Type p_208672_, DensityFunction p_208673_) {
            double d0 = p_208673_.minValue();
            double d1 = transform(p_208672_, d0);
            double d2 = transform(p_208672_, p_208673_.maxValue());
            return p_208672_ != OTGDensityFunctions.Mapped.Type.ABS && p_208672_ != OTGDensityFunctions.Mapped.Type.SQUARE
                ? new OTGDensityFunctions.Mapped(p_208672_, p_208673_, d1, d2)
                : new OTGDensityFunctions.Mapped(p_208672_, p_208673_, Math.max(0.0, d0), Math.max(d1, d2));
        }

        private static double transform(OTGDensityFunctions.Mapped.Type p_208669_, double p_208670_) {
        ...
        public OTGDensityFunctions.Mapped mapAll(DensityFunction.Visitor p_208677_) {
        ...
        static enum Type implements StringRepresentable {
            ...
            final KeyDispatchDataCodec<OTGDensityFunctions.Mapped> codec = OTGDensityFunctions.singleFunctionArgumentCodec(
                p_208700_ -> OTGDensityFunctions.Mapped.create(this, p_208700_), OTGDensityFunctions.Mapped::input
            );
    ...
    protected static record Marker(OTGDensityFunctions.Marker.Type type, DensityFunction wrapped) implements OTGDensityFunctions.MarkerOrMarked {
        ...
        @Override
        public OTGDensityFunctions.Marker.Type type() {
            return this.type;
        }
        ...
        static enum Type implements StringRepresentable {
            ...
            private final String name;
            final KeyDispatchDataCodec<OTGDensityFunctions.MarkerOrMarked> codec = OTGDensityFunctions.singleFunctionArgumentCodec(
                p_208740_ -> new OTGDensityFunctions.Marker(this, p_208740_), OTGDensityFunctions.MarkerOrMarked::wrapped
            );
    ...
    public interface MarkerOrMarked extends DensityFunction {
        ...
        default DensityFunction mapAll(DensityFunction.Visitor p_224070_) {
            return p_224070_.apply(new OTGDensityFunctions.Marker(this.type(), this.wrapped().mapAll(p_224070_)));
        }
    }

    static record MulOrAdd(OTGDensityFunctions.MulOrAdd.Type specificType, DensityFunction input, double minValue, double maxValue, double argument)
        implements OTGDensityFunctions.PureTransformer,
        OTGDensityFunctions.TwoArgumentSimpleFunction {
        @Override
        public OTGDensityFunctions.TwoArgumentSimpleFunction.Type type() {
            return this.specificType == OTGDensityFunctions.MulOrAdd.Type.MUL
                ? OTGDensityFunctions.TwoArgumentSimpleFunction.Type.MUL
                : OTGDensityFunctions.TwoArgumentSimpleFunction.Type.ADD;
        }
    ...
    protected static record Noise(DensityFunction.NoiseHolder noise, @Deprecated double xzScale, double yScale) implements DensityFunction {
        public static final MapCodec<OTGDensityFunctions.Noise> DATA_CODEC = RecordCodecBuilder.mapCodec(
            p_208798_ -> p_208798_.group(
                        DensityFunction.NoiseHolder.CODEC.fieldOf("noise").forGetter(OTGDensityFunctions.Noise::noise),
                        Codec.DOUBLE.fieldOf("xz_scale").forGetter(OTGDensityFunctions.Noise::xzScale),
                        Codec.DOUBLE.fieldOf("y_scale").forGetter(OTGDensityFunctions.Noise::yScale)
                    )
                    .apply(p_208798_, OTGDensityFunctions.Noise::new)
        );
        public static final KeyDispatchDataCodec<OTGDensityFunctions.Noise> CODEC = OTGDensityFunctions.makeCodec(DATA_CODEC);
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_224077_) {
            return p_224077_.apply(new OTGDensityFunctions.Noise(p_224077_.visitNoise(this.noise), this.xzScale, this.yScale));
        }
    ...
    static record RangeChoice(DensityFunction input, double minInclusive, double maxExclusive, DensityFunction whenInRange, DensityFunction whenOutOfRange)
        ...
        public static final MapCodec<OTGDensityFunctions.RangeChoice> DATA_CODEC = RecordCodecBuilder.mapCodec(
            p_208837_ -> p_208837_.group(
                        DensityFunction.HOLDER_HELPER_CODEC.fieldOf("input").forGetter(OTGDensityFunctions.RangeChoice::input),
                        OTGDensityFunctions.NOISE_VALUE_CODEC.fieldOf("min_inclusive").forGetter(OTGDensityFunctions.RangeChoice::minInclusive),
                        OTGDensityFunctions.NOISE_VALUE_CODEC.fieldOf("max_exclusive").forGetter(OTGDensityFunctions.RangeChoice::maxExclusive),
                        DensityFunction.HOLDER_HELPER_CODEC.fieldOf("when_in_range").forGetter(OTGDensityFunctions.RangeChoice::whenInRange),
                        DensityFunction.HOLDER_HELPER_CODEC.fieldOf("when_out_of_range").forGetter(OTGDensityFunctions.RangeChoice::whenOutOfRange)
                    )
                    .apply(p_208837_, OTGDensityFunctions.RangeChoice::new)
        );
        public static final KeyDispatchDataCodec<OTGDensityFunctions.RangeChoice> CODEC = OTGDensityFunctions.makeCodec(DATA_CODEC);
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_208841_) {
            return p_208841_.apply(
                new OTGDensityFunctions.RangeChoice(
    ...
    protected static record Shift(DensityFunction.NoiseHolder offsetNoise) implements OTGDensityFunctions.ShiftNoise {
        static final KeyDispatchDataCodec<OTGDensityFunctions.Shift> CODEC = OTGDensityFunctions.singleArgumentCodec(
            DensityFunction.NoiseHolder.CODEC, OTGDensityFunctions.Shift::new, OTGDensityFunctions.Shift::offsetNoise
        );
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_224087_) {
            return p_224087_.apply(new OTGDensityFunctions.Shift(p_224087_.visitNoise(this.offsetNoise)));
        }
    ...
    protected static record ShiftA(DensityFunction.NoiseHolder offsetNoise) implements OTGDensityFunctions.ShiftNoise {
        static final KeyDispatchDataCodec<OTGDensityFunctions.ShiftA> CODEC = OTGDensityFunctions.singleArgumentCodec(
            DensityFunction.NoiseHolder.CODEC, OTGDensityFunctions.ShiftA::new, OTGDensityFunctions.ShiftA::offsetNoise
        );
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_224093_) {
            return p_224093_.apply(new OTGDensityFunctions.ShiftA(p_224093_.visitNoise(this.offsetNoise)));
        }
    ...
    protected static record ShiftB(DensityFunction.NoiseHolder offsetNoise) implements OTGDensityFunctions.ShiftNoise {
        static final KeyDispatchDataCodec<OTGDensityFunctions.ShiftB> CODEC = OTGDensityFunctions.singleArgumentCodec(
            DensityFunction.NoiseHolder.CODEC, OTGDensityFunctions.ShiftB::new, OTGDensityFunctions.ShiftB::offsetNoise
        );
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_224099_) {
            return p_224099_.apply(new OTGDensityFunctions.ShiftB(p_224099_.visitNoise(this.offsetNoise)));
        }
    ...
    protected static record ShiftedNoise(
        ...
        private static final MapCodec<OTGDensityFunctions.ShiftedNoise> DATA_CODEC = RecordCodecBuilder.mapCodec(
            p_208943_ -> p_208943_.group(
                        DensityFunction.HOLDER_HELPER_CODEC.fieldOf("shift_x").forGetter(OTGDensityFunctions.ShiftedNoise::shiftX),
                        DensityFunction.HOLDER_HELPER_CODEC.fieldOf("shift_y").forGetter(OTGDensityFunctions.ShiftedNoise::shiftY),
                        DensityFunction.HOLDER_HELPER_CODEC.fieldOf("shift_z").forGetter(OTGDensityFunctions.ShiftedNoise::shiftZ),
                        Codec.DOUBLE.fieldOf("xz_scale").forGetter(OTGDensityFunctions.ShiftedNoise::xzScale),
                        Codec.DOUBLE.fieldOf("y_scale").forGetter(OTGDensityFunctions.ShiftedNoise::yScale),
                        DensityFunction.NoiseHolder.CODEC.fieldOf("noise").forGetter(OTGDensityFunctions.ShiftedNoise::noise)
                    )
                    .apply(p_208943_, OTGDensityFunctions.ShiftedNoise::new)
        );
        public static final KeyDispatchDataCodec<OTGDensityFunctions.ShiftedNoise> CODEC = OTGDensityFunctions.makeCodec(DATA_CODEC);
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_208947_) {
            return p_208947_.apply(
                new OTGDensityFunctions.ShiftedNoise(
    ...
    public static record Spline(CubicSpline<OTGDensityFunctions.Spline.Point, OTGDensityFunctions.Spline.Coordinate> spline) implements DensityFunction {
        private static final Codec<CubicSpline<OTGDensityFunctions.Spline.Point, OTGDensityFunctions.Spline.Coordinate>> SPLINE_CODEC = CubicSpline.codec(
            OTGDensityFunctions.Spline.Coordinate.CODEC
        );
        private static final MapCodec<OTGDensityFunctions.Spline> DATA_CODEC = SPLINE_CODEC.fieldOf("spline")
            .xmap(OTGDensityFunctions.Spline::new, OTGDensityFunctions.Spline::spline);
        public static final KeyDispatchDataCodec<OTGDensityFunctions.Spline> CODEC = OTGDensityFunctions.makeCodec(DATA_CODEC);

        @Override
        public double compute(DensityFunction.FunctionContext p_211715_) {
            return (double)this.spline.apply(new OTGDensityFunctions.Spline.Point(p_211715_));
        }
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_211717_) {
            return p_211717_.apply(new OTGDensityFunctions.Spline(this.spline.mapAll(p_224119_ -> p_224119_.mapAll(p_211717_))));
        }
        ...
        public static record Coordinate(Holder<DensityFunction> function) implements ToFloatFunction<OTGDensityFunctions.Spline.Point> {
            public static final Codec<OTGDensityFunctions.Spline.Coordinate> CODEC = DensityFunction.CODEC
                .xmap(OTGDensityFunctions.Spline.Coordinate::new, OTGDensityFunctions.Spline.Coordinate::function);
            ...
            public float apply(OTGDensityFunctions.Spline.Point p_224130_) {
            ...
            public OTGDensityFunctions.Spline.Coordinate mapAll(DensityFunction.Visitor p_224128_) {
                return new OTGDensityFunctions.Spline.Coordinate(new Holder.Direct<>(this.function.value().mapAll(p_224128_)));
            }
        }
    ...
    interface TwoArgumentSimpleFunction extends DensityFunction {
        ...
        static OTGDensityFunctions.TwoArgumentSimpleFunction create(
            OTGDensityFunctions.TwoArgumentSimpleFunction.Type p_209074_, DensityFunction p_209075_, DensityFunction p_209076_
        ) {
            double d0 = p_209075_.minValue();
            double d1 = p_209076_.minValue();
            double d2 = p_209075_.maxValue();
            double d3 = p_209076_.maxValue();
            if (p_209074_ == OTGDensityFunctions.TwoArgumentSimpleFunction.Type.MIN || p_209074_ == OTGDensityFunctions.TwoArgumentSimpleFunction.Type.MAX) {
                boolean flag = d0 >= d3;
                boolean flag1 = d1 >= d2;
                if (flag || flag1) {
            ...
            if (p_209074_ == OTGDensityFunctions.TwoArgumentSimpleFunction.Type.MUL || p_209074_ == OTGDensityFunctions.TwoArgumentSimpleFunction.Type.ADD) {
                if (p_209075_ instanceof OTGDensityFunctions.Constant densityfunctions$constant1) {
                    return new OTGDensityFunctions.MulOrAdd(
                        p_209074_ == OTGDensityFunctions.TwoArgumentSimpleFunction.Type.ADD
                            ? OTGDensityFunctions.MulOrAdd.Type.ADD
                            : OTGDensityFunctions.MulOrAdd.Type.MUL,
                        p_209076_,
                        d5,
                        d4,
                ...
                if (p_209076_ instanceof OTGDensityFunctions.Constant densityfunctions$constant) {
                    return new OTGDensityFunctions.MulOrAdd(
                        p_209074_ == OTGDensityFunctions.TwoArgumentSimpleFunction.Type.ADD
                            ? OTGDensityFunctions.MulOrAdd.Type.ADD
                            : OTGDensityFunctions.MulOrAdd.Type.MUL,
            ...
            return new OTGDensityFunctions.Ap2(p_209074_, p_209075_, p_209076_, d5, d4);
        }
        ...
        public static enum Type implements StringRepresentable {
            ...
            final KeyDispatchDataCodec<OTGDensityFunctions.TwoArgumentSimpleFunction> codec = OTGDensityFunctions.doubleFunctionArgumentCodec(
                (p_209092_, p_209093_) -> OTGDensityFunctions.TwoArgumentSimpleFunction.create(this, p_209092_, p_209093_),
                OTGDensityFunctions.TwoArgumentSimpleFunction::argument1,
                OTGDensityFunctions.TwoArgumentSimpleFunction::argument2
            );
            private final String name;
    ...
    protected static record WeirdScaledSampler(
        DensityFunction input, DensityFunction.NoiseHolder noise, OTGDensityFunctions.WeirdScaledSampler.RarityValueMapper rarityValueMapper
    ) implements OTGDensityFunctions.TransformerWithContext {
        private static final MapCodec<OTGDensityFunctions.WeirdScaledSampler> DATA_CODEC = RecordCodecBuilder.mapCodec(
            p_208438_ -> p_208438_.group(
                        DensityFunction.HOLDER_HELPER_CODEC.fieldOf("input").forGetter(OTGDensityFunctions.WeirdScaledSampler::input),
                        DensityFunction.NoiseHolder.CODEC.fieldOf("noise").forGetter(OTGDensityFunctions.WeirdScaledSampler::noise),
                        OTGDensityFunctions.WeirdScaledSampler.RarityValueMapper.CODEC
                            .fieldOf("rarity_value_mapper")
                            .forGetter(OTGDensityFunctions.WeirdScaledSampler::rarityValueMapper)
                    )
                    .apply(p_208438_, OTGDensityFunctions.WeirdScaledSampler::new)
        );
        public static final KeyDispatchDataCodec<OTGDensityFunctions.WeirdScaledSampler> CODEC = OTGDensityFunctions.makeCodec(DATA_CODEC);
        ...
        public DensityFunction mapAll(DensityFunction.Visitor p_208443_) {
            return p_208443_.apply(
                new OTGDensityFunctions.WeirdScaledSampler(this.input.mapAll(p_208443_), p_208443_.visitNoise(this.noise), this.rarityValueMapper)
            );
        }
        ...
        public static enum RarityValueMapper implements StringRepresentable {
            ...
            public static final Codec<OTGDensityFunctions.WeirdScaledSampler.RarityValueMapper> CODEC = StringRepresentable.fromEnum(
                OTGDensityFunctions.WeirdScaledSampler.RarityValueMapper::values
            );
            private final String name;
    ...
    static record YClampedGradient(int fromY, int toY, double fromValue, double toValue) implements DensityFunction.SimpleFunction {
        private static final MapCodec<OTGDensityFunctions.YClampedGradient> DATA_CODEC = RecordCodecBuilder.mapCodec(
            p_208494_ -> p_208494_.group(
                        Codec.intRange(DimensionType.MIN_Y * 2, DimensionType.MAX_Y * 2)
                            .fieldOf("from_y")
                            .forGetter(OTGDensityFunctions.YClampedGradient::fromY),
                        Codec.intRange(DimensionType.MIN_Y * 2, DimensionType.MAX_Y * 2)
                            .fieldOf("to_y")
                            .forGetter(OTGDensityFunctions.YClampedGradient::toY),
                        OTGDensityFunctions.NOISE_VALUE_CODEC.fieldOf("from_value").forGetter(OTGDensityFunctions.YClampedGradient::fromValue),
                        OTGDensityFunctions.NOISE_VALUE_CODEC.fieldOf("to_value").forGetter(OTGDensityFunctions.YClampedGradient::toValue)
                    )
                    .apply(p_208494_, OTGDensityFunctions.YClampedGradient::new)
        );
        public static final KeyDispatchDataCodec<OTGDensityFunctions.YClampedGradient> CODEC = OTGDensityFunctions.makeCodec(DATA_CODEC);
